...
<%
			stmt.executeUpdate("update light set state='N' where state = 'Y';");
...
<%
			stmt.executeUpdate("update light set state='Y' where state = 'N';");
			stmt.executeUpdate("insert into light_log (state, time) values('Y','"+time +"')");
		}
	}
